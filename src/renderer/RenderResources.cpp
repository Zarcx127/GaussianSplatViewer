...
bool RenderResources::build(
    ...
    GraphicsPipelineConfig meshPipelineConfig = get_mesh_pipeline_config();

    m_meshPipeline = make_graphics_pipeline(
        context.logicalDevice,
...
vk::Pipeline RenderResources::mesh_pipeline() const
{
